...
if __name__ == "__main__":
    plotter = Plotter(actor_ids=[1046, 766, 1928], log_path=os.path.join("lunar_lander_cont_agent2", "actor_logs"), track_logs=["EpisodeLength", "TotalReward", "EpisodeTime"], name="D3PG")
    plotter.show()